...
import heroImage1 from "../assets/apocorp_animation_card-1.png";
import heroImage2 from "../assets/apocorp_animation_card-2.png";
import heroImage3 from "../assets/apocorp_animation_card-3.png";
import "../Styles/AnimateApoCorp.css";
...
function AnimateApoCorp() {
    ...
    return (
        <section className="apo-scroll-section" ref={sectionRef}>
            <div className="apo-stage" id="apo-stage">
                <div className="apo-bg-overlay" id="bg-overlay"></div>
                ...
                <div className="apo-main-content" id="apo-content">
                    <div className="apo-card-stack">
                        ...
                        <div className="apo-glass-card apo-glass-card--compact" id="card-1">
                            ...
                            <div className="apo-card-media">
                                <img src={heroImage1} alt="Factory operations dashboard" />
                            </div>
                        </div>
                    </div>
                    {/* <!-- Card 2 --> */}
                    <div className="apo-glass-card" id="card-2">
                        ...
                        <div className="apo-card-media">
                            <img src={heroImage2} alt="Factory operations dashboard" />
                        </div>
                    </div>
                    {/* <!-- Card 3 --> */}
                    <div className="apo-glass-card" id="card-3">
                        ...
                        <div className="apo-card-media">
                            <img src={heroImage3} alt="Factory operations dashboard" />
                        </div>
                    </div>
                </div>
            </div>
